<?php
    ...
    if(isset($_POST['donnees_geologiques'])) {


        $_SESSION['cartes_affleurements'] = $_POST['cartes_affleurements'];
        $_SESSION['observations_cartes_affleurements'] = $_POST['observations_cartes_affleurements'];
        $_SESSION['carte_geologique'] = $_POST['carte_geologique'];
        $_SESSION['observations_carte_geologique'] = $_POST['observations_carte_geologique'];
        $_SESSION['donnees_geochimie'] = $_POST['donnees_geochimie'];
        $_SESSION['observations_donnees_geochimie'] = $_POST['observations_donnees_geochimie'];
        $_SESSION['cartes_geochimie'] = $_POST['cartes_geochimie'];
        $_SESSION['observations_cartes_geochimie'] = $_POST['observations_cartes_geochimie'];
        $_SESSION['geophysique_aeroportee_drone'] = $_POST['geophysique_aeroportee_drone'];
        $_SESSION['observations_geophysique_aeroportee_drone'] = $_POST['observations_geophysique_aeroportee_drone'];
        $_SESSION['geophysique_sol'] = $_POST['geophysique_sol'];
        $_SESSION['observations_geophysique_sol'] = $_POST['observations_geophysique_sol'];
        $_SESSION['tranchees_puits'] = $_POST['tranchees_puits'];
        $_SESSION['observations_tranchees_puits'] = $_POST['observations_tranchees_puits'];
        ...
        tranchees_puits, observations_tranchees_puits)
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
                ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
                ?,?,?,?,?,?,?,?,?,?,?,
                ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            ...
                            <img src="../assets/img/Senegal Flag.png" style="padding:auto; margin:auto;" width="20%" height="10%" alt="">
                            <h3>AUDIT MINIER</h3>
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="form7.php">Dashboard 1</a>
                                </li>
                                <!--<li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form6.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Données Géologiques</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">8 - Données Géologiques (#Audit Géologique) </h3>
                                        </div>
                                        <hr>
                                        <form action="form7.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            (Sur site; indicateurs à incidence sur l'inventaire des ressources & réserves et sur la cartographie nationale)
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Cartes des affleurements</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="cartes_affleurements" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="cartes_affleurements" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="observations_cartes_affleurements" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_cartes_affleurements']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Carte géologique</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="carte_geologique" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="carte_geologique" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_carte_geologique" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_carte_geologique']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Géochimie (données)</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="donnees_geochimie" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="donnees_geochimie" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_donnees_geochimie" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_donnees_geochimie']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Géochimie (cartes)</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="cartes_geochimie" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="cartes_geochimie" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_cartes_geochimie" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_cartes_geochimie']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Géophysique aéroportée ou levé par Drones</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="geophysique_aeroportee_drone" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="geophysique_aeroportee_drone" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_geophysique_aeroportee_drone" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_geophysique_aeroportee_drone']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Géophysique Sol</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="geophysique_sol" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="geophysique_sol" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_geophysique_sol" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_geophysique_sol']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Tranchées et Puits</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="tranchees_puits" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="tranchees_puits" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_tranchees_puits" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_tranchees_puits']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="donnees_geologiques" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
