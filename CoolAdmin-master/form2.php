<?php
    ...
    if(isset($_POST['identification_site'])) {

        $_SESSION['region_siege'] = $_POST['region_siege'];
        $_SESSION['departement_siege'] = $_POST['departement_siege'];
        $_SESSION['commune_siege'] = $_POST['commune_siege'];
        $_SESSION['village'] = $_POST['village'];
        $_SESSION['utm_gps'] = $_POST['utm_gps'];
        $_SESSION['x_gps'] = $_POST['x_gps'];
        $_SESSION['y_gps'] = $_POST['y_gps'];
        $_SESSION['surface'] = $_POST['surface'];
        $_SESSION['activites_minieres'] = $_POST['activites_minieres'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form1.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Identification du lieu du site minier <?php echo $_SESSION['site_minier'] ?></div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">3 - Identification du lieu du site minier</h3>
                                        </div>
                                        <hr>
                                        <form action="form2.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Région Siège administrative</label>
                                                        <select name="region_siege" id="select" class="form-control">
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Département Siège administrative</label>
                                                    <div class="input-group">
                                                        <select name="departement_siege" id="select" class="form-control">
                                                            ...
                                                            <option value="Matam">Matam</option>
                                                            <option value="Ranérou">Ranérou</option>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Commune Siège administrative</label>
                                                        <input id="cc-exp" name="commune_siege" type="text" value="<?php echo $_SESSION['commune_siege']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="Commune"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Village le plus proche</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="village" type="text" value="<?php echo $_SESSION['village']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">UTM (Coordonnées GPS)</label>
                                                        <input id="cc-exp" name="utm_gps" type="text" value="<?php echo $_SESSION['utm_gps']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="UTM"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">X (Coordonnées GPS)</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="x_gps" type="text" value="<?php echo $_SESSION['x_gps']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Y (Coordonnées GPS)</label>
                                                        <input id="cc-exp" name="y_gps" type="text" value="<?php echo $_SESSION['y_gps']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Surface en Ha (Coordonnées GPS)</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="surface" type="text" value="<?php echo $_SESSION['surface']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" placeholder="Surface (Ha)" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-8">
                                                    <label for="x_card_code" class="control-label mb-1">Les activités minières sont-elles conformes géographiquement aux données du permis d’exploitation
                                                    </label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="activites_minieres" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                        <input id="x_card_code" name="activites_minieres" type="checkbox" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="Non">Non
                                            ...
                                            <br>
                                            <div>
                                                <button id="payment-button" name="identification_site" type="submit" class="btn btn-lg btn-info btn-block">
