<?php
    ...
    if(isset($_POST['information_operateur'])) {


        $_SESSION['representant_principal'] = $_POST['representant_principal'];
        $_SESSION['titre_fonction'] = $_POST['titre_fonction'];
        $_SESSION['signature_numerique'] = $_POST['signature_numerique'];
        $_SESSION['gestionnaire_responsable'] = $_POST['gestionnaire_responsable'];
        $_SESSION['commentaire_gestionnaire'] = $_POST['commentaire_gestionnaire'];
        
        

        header("Location:form27.php");
        ...
        signature_numerique, gestionnaire_responsable, commentaire_gestionnaire)
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
        ?,?,?,?,?)');*/
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form25.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">INFORMATION DE L'OPERATEUR DU SITE MINIER SUR LES CONCLUSIONS PRELIMINAIRES DE L’INSPECTION</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">27 - INFORMATION DE L'OPERATEUR DU SITE MINIER SUR LES CONCLUSIONS PRELIMINAIRES DE L’INSPECTION</h3>
                                        </div>
                                        <hr>
                                        <form action="form26.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                        Cette section documente que l’exploitant minier (représenté par le personnel responsable et confirmé par le gestionnaire responsable) a compris et accepte le processus d’inspection et de toutes ses conclusions.
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="representant_principal" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['representant_principal']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="titre_fonction" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['titre_fonction']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Signature (prévoir une signature numérique directement sur la tablette ou l'interface)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="signature_numerique" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['signature_numerique']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="gestionnaire_responsable" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['gestionnaire_responsable']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Commentaire du gestionnaire en matière d’inspection
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="commentaire_gestionnaire" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['commentaire_gestionnaire']?>
                                                        </textarea>
                                            ...
                                            <!--<div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                    <input id="x_card_code" name="signature" type="file" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div>
                                                <button name="information_operateur" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
