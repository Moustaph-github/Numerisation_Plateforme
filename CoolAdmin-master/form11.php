<?php
    ...
    if(isset($_POST['methodes_exploitation_miniere'])) {


        $_SESSION['methodes_exploitation'] = $_POST['methodes_exploitation'];
        $_SESSION['autres_methodes_exploitation'] = $_POST['autres_methodes_exploitation'];
        $_SESSION['compresseurs'] = $_POST['compresseurs'];
        $_SESSION['equipements_lourds'] = $_POST['equipements_lourds'];
        $_SESSION['marteau_piqueur'] = $_POST['marteau_piqueur'];
        $_SESSION['pompes_eau'] = $_POST['pompes_eau'];
        $_SESSION['equipement_bonne_condition'] = $_POST['equipement_bonne_condition'];
        $_SESSION['equipement_en_panne'] = $_POST['equipement_en_panne'];
        $_SESSION['plan_formation_operateurs'] = $_POST['plan_formation_operateurs'];
        $_SESSION['autres_equipements'] = $_POST['autres_equipements'];
        $_SESSION['orpaillage'] = $_POST['orpaillage'];
        $_SESSION['concasseur_broyeur'] = $_POST['concasseur_broyeur'];
        $_SESSION['jigs'] = $_POST['jigs'];
        $_SESSION['table_secousses'] = $_POST['table_secousses'];

        $_SESSION['lixiviation'] = $_POST['lixiviation'];
        $_SESSION['amalgamation'] = $_POST['amalgamation'];
        $_SESSION['autres_methodes_exploitations'] = $_POST['autres_methodes_exploitations'];
        $_SESSION['perte_minerais_fins'] = $_POST['perte_minerais_fins'];
        $_SESSION['produits_economiques'] = $_POST['produits_economiques'];
        $_SESSION['pre_concentre'] = $_POST['pre_concentre'];
        $_SESSION['concentre'] = $_POST['concentre'];
        $_SESSION['residu_traitement'] = $_POST['residu_traitement'];
        $_SESSION['autre_produit_economique'] = $_POST['autre_produit_economique'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form10.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">METHODES D’EXPLOITATION MINIERE ET DE TRAITEMENT DES MINERAIS</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">12 - Méhodes d'exploitation minière et de traitement des minerais</h3>
                                        </div>
                                        <hr>
                                        <form action="form11.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Sur Site avec commentaires en Note / Action
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Méthodes d’exploitation</strong>
                                                        </label>
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="methodes_exploitation" type="checkbox" class="form-control cc-cvc" value="Hydraulique (lavage au sluice)" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Hydraulique (lavage au sluice)
                                                            <input id="x_card_code" name="methodes_exploitation" type="checkbox" class="form-control cc-cvc" value="Manuelle (pelle, marteau, burin...)" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Manuelle (pelle, marteau, burin...)
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="methodes_exploitation" type="checkbox" class="form-control cc-cvc" value="Physique (minage)" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Physique (minage)
                                                            <input id="x_card_code" name="methodes_exploitation" type="checkbox" class="form-control cc-cvc" value="Mécanique (p.ex. excavateur)" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Mécanique (p.ex. excavateur)  
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="autres_methodes_exploitation" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['autres_methodes_exploitation']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>
                                                                EMPLOI EQUIPEMENT MINIER (LISTE MINIERE : PRINCIPAUX EQUIPEMENTS POUVANT JUSTIFIER LA CAPACITE DE PRODUCTION). REPONDRE EN INDIQUANT DES DETAILS AU BESOIN
                                                            </strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">Compresseurs</label>
                                                    <div class="input-group">
                                                        <textarea name="compresseurs" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['compresseurs']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Equipements lourds (p. ex., excavateurs, bulldozers ; donnez les détails)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="equipements_lourds" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['equipements_lourds']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="marteau_piqueur" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['marteau_piqueur']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="pompes_eau" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['pompes_eau']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Equipement en bonne conditions et bien entretenus
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="equipement_bonne_condition" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['equipement_bonne_condition']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Equipement(s) en panne (donnez les détails)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="equipement_en_panne" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['equipement_en_panne']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Plan de la formation des opérateurs des équipements et autres
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="plan_formation_operateurs" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['plan_formation_operateurs']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="autres_equipements" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['autres_equipements']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>
                                                                METHODES DE TRAITEMENT. REPONSE ET DES DETAILS AU BESOIN
                                                            </strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Pan de lavage (orpaillage)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="orpaillage" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['orpaillage']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="concasseur_broyeur" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['concasseur_broyeur']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="jigs" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['jigs']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="table_secousses" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['table_secousses']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="lixiviation" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['lixiviation']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="amalgamation" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['amalgamation']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="autres_methodes_exploitations" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['autres_methodes_exploitations']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        L’absence de traitement entraîne la perte des minerais fins
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="perte_minerais_fins" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['perte_minerais_fin']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>
                                                                PRODUITS ECONOMIQUES DU SITE. REPONSE ET DETAILS AU BESOIN
                                                            </strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Produits économiques du site
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="produits_economiques" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['produits_economiques']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="pre_concentre" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['pre_concentre']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="concentre" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['concentre']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="residu_traitement" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['residu_traitement']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="autre_produit_economique" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['autre_produit_economique']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="methodes_exploitation_miniere" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
