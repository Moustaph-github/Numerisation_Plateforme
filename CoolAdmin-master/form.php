<?php
    ...
    if(isset($_POST['reference'])) {    
        ...
        $_SESSION['site_minier'] = $_POST['site_minier'];
        $_SESSION['date_inspection'] = $_POST['date_inspection'];
        $_SESSION['inspecteur'] = $_POST['inspecteur'];
        $_SESSION['num_inspecteur'] = $_POST['num_inspecteur'];
        $_SESSION['sous_site_inspecte'] = $_POST['sous_site_inspecte'];
        $_SESSION['num_enreg_national'] = $_POST['num_enreg_national'];

        header("Location:form1.php");

        $site_minier = $_POST['site_minier'];
        $date_inspection = $_POST['date_inspection'];
        $inspecteur = $_POST['inspecteur'];
        $num_inspecteur = $_POST['num_inspecteur'];
        $sous_site_inspecte = $_POST['sous_site_inspecte'];
        $num_enreg_national = $_POST['num_enreg_national'];


        //$req = $bdd->prepare('INSERT INTO minier(site_minier, date_inspection, inspecteur, num_inspecteur, sous_site_inspecte, 
        //num_enreg_national) VALUES (?,?,?,?,?,?)');

        //$req->execute(array($site_minier, $date_inspection, $inspecteur, $num_inspecteur, $sous_site_inspecte,
        //$num_enreg_national));
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Reference de la Mission</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">1 - Reference de la Mission</h3>
                                        </div>
                                        <hr>
                                        <form action="form.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Site minier inspecte</label>
                                                        <input id="cc-exp" name="site_minier" type="text" value="<?php echo $_SESSION['site_minier']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Date(s) d’ inspection</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="date_inspection" type="date" value="<?php echo $_SESSION['date_inspection']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Inspecteur(s)</label>
                                                        <input id="cc-exp" name="inspecteur" type="text" value="<?php echo $_SESSION['inspecteur']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">N° d’inspection</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="num_inspecteur" type="text" value="<?php echo $_SESSION['num_inspecteur']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Sous-sites individuels inspectés</label>
                                                        <input id="cc-exp" name="sous_site_inspecte" type="text" value="<?php echo $_SESSION['sous_site_inspecte']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">N° d’enregistrement national du site minier</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="num_enreg_national" type="text" value="<?php echo $_SESSION['num_enreg_national']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                            ...
                                            <div>
                                                <button name="reference" type="submit" class="btn btn-lg btn-info btn-block">
