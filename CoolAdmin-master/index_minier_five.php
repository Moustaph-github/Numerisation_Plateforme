<?php
    ...
    $req = $bdd->prepare('SELECT * FROM minier_five');
    $req->execute();
    ...
    if(isset($_POST["exporter"]))
    {
        ...
        {
            $excel = "";
            $excel .= "Id\texploitant_site_minerais\tguide_ocde\tobservations_guide_ocde\tpolitiques_ddg\tobservations_politiques_ddg\ttenue_dossiers\tobservations_tenue_dossiers\tcomptabilite\tobservations_comptabilite\tresponsabilites_ddg_internes\tobservations_responsabilites_ddg_internes\ttracabilite_interne\tobservations_tracabilite_interne\ttracabilite_externe\tobservations_tracabilite_externe\tdocumentation_tracabilite\tobservations_documentation_tracabilite\tpuits_galerie\tobservations_puits_galerie\tpoints_agregation\tobservations_points_agregation\tmineurs_impliques\tobservations_mineurs_impliques\tdate_production\tobservations_date_production\tpoids_production\tobservations_poids_production\tvaleur_production\tobservations_valeur_production\ttracabilite_physique\tobservations_tracabilite_physique\tsite_minier_tracabilite\tobservations_site_minier_tracabilite\tsuperviseurs_tracabilite\tobservations_superviseurs_tracabilite\tsuperviseurs_compagnie\tobservations_superviseurs_compagnie\tsuperviseurs_semi_externes\tobservations_superviseurs_semi_externes\tsuperviseurs_externes_gouvernement\tobservations_superviseurs_externes_gouvernement\tsuperviseurs_tracabilite_permanence\tobservations_superviseurs_tracabilite_permanence\tnbre_visite_sous_site\tobservations_nbre_visite_sous_site\tminerais_sensibles\tobservations_minerais_sensibles\techantillonnage_afp\tobservations_echantillonnage_afp\trisques_itsci\tobservations_risques_itsci\taudit_mmg\tobservations_audit_mmg\taudit_interne\tobservations_audit_interne\tautre_audit\tminerais_non_traces\tobservations_minerais_non_traces\tsortie_minerais_non_traces\observations_sortie_minerais_non_traces\n";
            
            
            foreach($enregminier as $enregminier){
                $excel .= "$enregminier->id\t$enregminier->exploitant_site_minerais\t$enregminier->guide_ocde\t$enregminier->observations_guide_ocde\t$enregminier->politiques_ddg\t$enregminier->observations_politiques_ddg\t$enregminier->tenue_dossiers\t$enregminier->observations_tenue_dossiers\t$enregminier->comptabilite\t$enregminier->observations_comptabilite\t$enregminier->responsabilites_ddg_internes\t$enregminier->observations_responsabilites_ddg_internes\t$enregminier->tracabilite_interne\t$enregminier->observations_tracabilite_interne\t$enregminier->tracabilite_externe\t$enregminier->observations_tracabilite_externe\t$enregminier->documentation_tracabilite\t$enregminier->observations_documentation_tracabilite\t$enregminier->puits_galerie\t$enregminier->observations_puits_galerie\t$enregminier->points_agregation\t$enregminier->observations_points_agregation\t$enregminier->mineurs_impliques\t$enregminier->observations_mineurs_impliques\t$enregminier->date_production\t$enregminier->observations_date_production\t$enregminier->poids_production\t$enregminier->observations_poids_production\t$enregminier->valeur_production\t$enregminier->observations_valeur_production\t$enregminier->tracabilite_physique\t$enregminier->observations_tracabilite_physique\t$enregminier->site_minier_tracabilite\t$enregminier->observations_site_minier_tracabilite\t$enregminier->superviseurs_tracabilite\t$enregminier->observations_superviseurs_tracabilite\t$enregminier->superviseurs_compagnie\t$enregminier->observations_superviseurs_compagnie\t$enregminier->superviseurs_semi_externes\t$enregminier->observations_superviseurs_semi_externes\t$enregminier->superviseurs_externes_gouvernement\t$enregminier->observations_superviseurs_externes_gouvernement\t$enregminier->superviseurs_tracabilite_permanence\t$enregminier->observations_superviseurs_tracabilite_permanence\t$enregminier->nbre_visite_sous_site\t$enregminier->observations_nbre_visite_sous_site\t$enregminier->minerais_sensibles\t$enregminier->observations_minerais_sensibles\t$enregminier->echantillonnage_afp\t$enregminier->observations_echantillonnage_afp\t$enregminier->risques_itsci\t$enregminier->observations_risques_itsci\t$enregminier->audit_mmg\t$enregminier->observations_audit_mmg\t$enregminier->audit_interne\t$enregminier->observations_audit_interne\t$enregminier->autre_audit\t$enregminier->minerais_non_traces\t$enregminier->observations_minerais_non_traces\t$enregminier->sortie_minerais_non_traces\t$enregminier->observations_sortie_minerais_non_traces\n";
            }
            header('Content-type: application/vnd.ms-excel');
            header('Content-disposition: attachment; filename=minier-five.xls');
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form action="index_minier_five.php" method="post">
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                <th>Exploitant Site minerais</th>
                                                <th>Guide OCDE</th>
                                                <th>Observations Guide OCDE</th>
                                                <th class="text-right">Politiques DDG</th>
                                                <th class="text-right">Observations Politiques DDG</th>
                                                <th class="text-right">Tenue Dossiers</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <?php if($enregminier):
                                                foreach($enregminier as $enregminier): ?>
                                                <tr>
                                                    <td><?=$enregminier->exploitant_site_minerais;?></td>
                                                    <td><?=$enregminier->guide_ocde;?></td>
                                                    <td><?=$enregminier->observations_guide_ocde;?></td>
                                                    <td><?=$enregminier->politiques_ddg;?></td>
                                                    <td><?=$enregminier->observations_politiques_ddg;?></td>
                                                    <td><?=$enregminier->tenue_dossiers;?></td>
                                                </tr>
