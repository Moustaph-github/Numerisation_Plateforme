<?php
    ...
    if(isset($_POST['salaires_paiements'])) {


        $_SESSION['masse_salariale_annuelle'] = $_POST['masse_salariale_annuelle'];
        $_SESSION['salaire_max'] = $_POST['salaire_max'];
        $_SESSION['salaire_min'] = $_POST['salaire_min'];
        $_SESSION['salaire_normal'] = $_POST['salaire_normal'];
        $_SESSION['paiement_normal_sous_traitant'] = $_POST['paiement_normal_sous_traitant'];
        $_SESSION['paiement_normal_mineur'] = $_POST['paiement_normal_mineur'];
        $_SESSION['paiement_travailleur_temporaire'] = $_POST['paiement_travailleur_temporaire'];
        $_SESSION['moyens_paiement'] = $_POST['moyens_paiement'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form20.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">SALAIRES / PAIEMENTS</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">22 - SALAIRES / PAIEMENTS</h3>
                                        </div>
                                        <hr>
                                        <form action="form21.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="masse_salariale_annuelle" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['masse_salariale_annuelle']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="salaire_max" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['salaire_max']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="salaire_min" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['salaire_min']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Salaire normal d’un employé (de directeur à niveau moyen)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="salaire_normal" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['salaire_normal']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="paiement_normal_sous_traitant" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['paiement_normal_sous_traitant']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="paiement_normal_mineur" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['paiement_normal_mineur']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="paiement_travailleur_temporaire" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['paiement_travailleur_temporaire']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Les paiements se font:</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="moyens_paiement" type="checkbox" class="form-control cc-cvc" value="En espèces" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">En espèces,
                                                            <input id="x_card_code" name="moyens_paiement" type="checkbox" class="form-control cc-cvc" value="Par virement bancaire" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Par virement bancaire,
                                                            
                                                            
                                                    </div>
                                                    <hr>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="moyens_paiement" type="checkbox" class="form-control cc-cvc" value="Transfert d’argent" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Transfert d’argent ?
                                                        <input id="x_card_code" name="moyens_paiement" type="checkbox" class="form-control cc-cvc" value="Autres" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Autres
                                            ...
                                            <div>
                                                <button name="salaires_paiements" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
