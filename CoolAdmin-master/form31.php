<?php
    ...
    if(isset($_POST['declaration_inspecteur_minier'])) {    

        $_SESSION['lieu_inspection'] = $_POST['lieu_inspection'];
        $_SESSION['date_de_inspection'] = $_POST['date_de_inspection'];
        ...
        lieu_inspection, date_de_inspection)
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,
        ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');*/
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form30.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">DECLARATION D’INSPECTEUR MINIER</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">32 - DECLARATION D’INSPECTEUR MINIER</h3>
                                        </div>
                                        <hr>
                                        <form action="form31.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                        Cette section certifie que l’inspecteur minier principal prend la responsabilité de tous les résultats de l’inspection. La section est contresignée par le Directeur de la DCSOM.
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Nom de l’inspecteur minier principal</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                        Je certifie par la présente que j’ai réalisé l’inspection ci-dessus de façon aussi précise que possible et en faisant appel à mes connaissances et compétences. J’ai respecté la méthodologie décrite dans ce manuel d’inspections minières.
                                                        Je prends l’entière responsabilité de l’exactitude des rapports des résultats de l’inspection.
                                                        </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="lieu_inspection" type="text" class="form-control cc-cvc" value="<?php echo $_SESSION['lieu_inspection']?>" data-val="true" data-val-required="Please enter the security code"
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="date_de_inspection" type="date" class="form-control cc-exp" value="<?php echo $_SESSION['date_de_inspection']?>" data-val="true" data-val-required="Please enter the card expiration"
                                            ...
                                            <div>
                                                <button name="declaration_inspecteur_minier" type="submit" class="btn btn-lg btn-info btn-block">
