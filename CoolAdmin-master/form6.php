<?php
    ...
    if(isset($_POST['exploration_sites'])) {


        $_SESSION['localisation_topographie'] = $_POST['localisation_topographie'];
        $_SESSION['inspection_virtuelle'] = $_POST['inspection_virtuelle'];
        $_SESSION['etat_lieux_acces'] = $_POST['etat_lieux_acces'];
        $_SESSION['rehabilitation_sites_sondage'] = $_POST['rehabilitation_sites_sondage'];
        ...
        etat_lieux_acces, rehabilitation_sites_sondage)
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
                ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
                ?,?,?,?,?,?,?,?,?,?,?,
                ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');*/
        ...
        $_SESSION['rehabilitation_sites_sondage']
        ));
        */
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="form6.php">Dashboard 1</a>
                                </li>
                                <!--<li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form5.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Exploration : Accès et état des sites de sondage </div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">7 - Exploration : Accès et état des sites de sondage (#Audit Géologique)</h3>
                                        </div>
                                        <hr>
                                        <form action="form6.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Localisation du périmètre, topographie, élévation et végétation
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="localisation_topographie" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['localisation_topographie']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Si le(s) site(s) n'est(sont) pas accessible(s), ou si le programmes de forage a cessé, procéder à une inspection virtuelle (Google Maps)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="inspection_virtuelle" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['inspection_virtuelle']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Proximité par rapport à un centre de population, moyens d'accès au bien, état des routes d'accès, accès à l'eau et à l'électricité
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="etat_lieux_acces" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['etat_lieux_acces']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Réhabilitation des sites de sondage
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="rehabilitation_sites_sondage" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['rehabilitation_sites_sondage']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="exploration_sites" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
