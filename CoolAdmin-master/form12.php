<?php
    ...
    if(isset($_POST['controle_production_miniere'])) {


        $_SESSION['debut_activites_minieres'] = $_POST['debut_activites_minieres'];
        $_SESSION['duree_activites_minieres'] = $_POST['duree_activites_minieres'];
        $_SESSION['hauteurs_fronts_puits'] = $_POST['hauteurs_fronts_puits'];
        $_SESSION['granulometrie'] = $_POST['granulometrie'];
        $_SESSION['minerais_produits_secondaires'] = $_POST['minerais_produits_secondaires'];
        $_SESSION['capacite_machines_extraction'] = $_POST['capacite_machines_extraction'];
        $_SESSION['capacite_machines_traitement'] = $_POST['capacite_machines_traitement'];
        $_SESSION['modalite_transport_minerai'] = $_POST['modalite_transport_minerai'];
        $_SESSION['modalite_transport_concentre'] = $_POST['modalite_transport_concentre'];
        $_SESSION['quantites_globales_mines'] = $_POST['quantites_globales_mines'];
        $_SESSION['teneur_moyenne_alimentation'] = $_POST['teneur_moyenne_alimentation'];
        $_SESSION['teneur_moyenne_concentre'] = $_POST['teneur_moyenne_concentre'];
        $_SESSION['taux_recuperation_moyen'] = $_POST['taux_recuperation_moyen'];
        $_SESSION['quantites_produites_type'] = $_POST['quantites_produites_type'];

        $_SESSION['quantites_vendues_mines'] = $_POST['quantites_vendues_mines'];
        $_SESSION['stocks_ouverture_produits'] = $_POST['stocks_ouverture_produits'];
        $_SESSION['stocks_fermeture_produits'] = $_POST['stocks_fermeture_produits'];
        $_SESSION['acheteurs'] = $_POST['acheteurs'];
        $_SESSION['produits_vendus'] = $_POST['produits_vendus'];
        $_SESSION['prix_ventes_produit'] = $_POST['prix_ventes_produit'];
        $_SESSION['recettes_produits_vendus'] = $_POST['recettes_produits_vendus'];
        $_SESSION['tonnage_produit'] = $_POST['tonnage_produit'];
        $_SESSION['tonnage_vendu'] = $_POST['tonnage_vendu'];
        $_SESSION['stocks_terril'] = $_POST['stocks_terril'];
        $_SESSION['modalite_controle'] = $_POST['modalite_controle'];
        $_SESSION['autres_modalites_controle'] = $_POST['autres_modalites_controle'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form11.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">CONTRÔLE DE LA PRODUCTION (# AUDIT MINIER)</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">13 - Contrôle de la production (#AUDIT MINIER)</h3>
                                        </div>
                                        <hr>
                                        <form action="form12.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Sur site et au bureau de l’exploitant minier (et du MMG/DCSOM)
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>
                                                                ACTIVITES ET DONNEES D'EXPLOITATION. REPONDRE EN DONNANT DES DETAILS AU BESOIN
                                                            </strong> 
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Début des activités minières (date ou année)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="debut_activites_minieres" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['debut_activites_minieres']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Durée des activités minières en année(s)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="duree_activites_minieres" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['duree_activites_minieres']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Hauteurs des fronts ou profondeur du(des) puits
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="hauteurs_fronts_puits" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['hauteurs_fronts_puits']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Minerais exploités ou types de produits fabriqués (granulométrie, etc.)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="granulometrie" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['granulometrie']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Minerai(s) ou Produit(s) secondaire(s)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="minerais_produits_secondaires" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['minerais_produits_secondaires']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Capacité des machines d'extraction sur le site d'extraction
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="capacite_machines_extraction" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['capacite_machines_extraction']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Capacité des machines de traitement installées (ex. Concasseurs, Broyeurs)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="capacite_machines_traitement" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['capacite_machines_traitement']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Modalité de transport du minerai Tout Venant
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="modalite_transport_minerai" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['modalite_transport_minerai']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Modalité de transport du concentré final vers l'extérieur
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="modalite_transport_concentre" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['modalite_transport_concentre']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Quantités globales extraites (Tout Venant Global Mine) - Total sur l'année en cours
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="quantites_globales_mines" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['quantites_globales_mines']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Teneur moyenne d'alimentation réalisée (teneur avant traitement)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="teneur_moyenne_alimentation" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['teneur_moyenne_alimentation']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Teneur moyenne du concentré (teneur aprés traitement)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="teneur_moyenne_concentre" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['teneur_moyenne_concentre']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="taux_recuperation_moyen" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['taux_recuperation_moyen']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Quantités produites par type (par minerai, par granulométrie, etc.) - Total sur l'année en cours
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="quantites_produites_type" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['quantites_produites_type']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Quantités vendues - Total sur l'année en cours
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="quantites_vendues_mines" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['quantites_vendues_mines']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Stocks d'ouverture par produits
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="stocks_ouverture_produits" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['stocks_ouverture_produits']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Stocks de fermeture par produits
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="stocks_fermeture_produits" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['stocks_fermeture_produits']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        <strong>VENTE DE LA PRODUCTION</strong>  
                                                    </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="acheteurs" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['acheteurs']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="produits_vendus" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['produits_vendus']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Prix de ventes réalisés par type de produit commercialisé
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="prix_ventes_produit" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['prix_ventes_produit']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Recettes par types de produits vendues
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="recettes_produits_vendus" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['recettes_produits_vendus']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Résidus de traitement : tonnage produit
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="tonnage_produit" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['tonnage_produit']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Résidus de traitement valorisés : tonnage vendu
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="tonnage_vendu" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['tonnage_vendu']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Résidus de traitement : stockés en terril ?
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="stockes_terril" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['stockes_terril']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        <strong>
                                                            MODALITE DE CONTROLE DES PARAMETRES DE PRODUCTION
                                                        </strong>  
                                                    </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="modalite_controle" type="checkbox" class="form-control cc-cvc" value="Par Documents" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Par Documents
                                                            <input id="x_card_code" name="modalite_controle" type="checkbox" class="form-control cc-cvc" value="Par interview de l'exploitant sur site" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Par interview de l'exploitant sur site
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="modalite_controle" type="checkbox" class="form-control cc-cvc" value="Par interview de la compagnie au Siège" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Par interview de la compagnie au Siège
                                                            <input id="x_card_code" name="modalite_controle" type="checkbox" class="form-control cc-cvc" value="Par Contrôle intermittent de la DCSOM" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Par Contrôle intermittent de la DCSOM  
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="autres_modalites_controle" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['autres_modalites_controle']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="controle_production_miniere" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
