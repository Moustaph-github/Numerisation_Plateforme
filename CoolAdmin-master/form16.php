<?php
    ...
    if(isset($_POST['securite_site'])) {


        $_SESSION['forces_publiques'] = $_POST['forces_publiques'];
        $_SESSION['observations_forces_publiques'] = $_POST['observations_forces_publiques'];
        $_SESSION['forces_privees'] = $_POST['forces_privees'];
        $_SESSION['observations_forces_privees'] = $_POST['observations_forces_privees'];
        $_SESSION['forces_engagees_exploitant'] = $_POST['forces_engagees_exploitant'];
        $_SESSION['observations_forces_engagees_exploitant'] = $_POST['observations_forces_engagees_exploitant'];
        $_SESSION['total_forces_securite'] = $_POST['total_forces_securite'];
        $_SESSION['observations_total_forces_securite'] = $_POST['observations_total_forces_securite'];
        $_SESSION['dimensions_mine'] = $_POST['dimensions_mine'];
        $_SESSION['observations_dimensions_mine'] = $_POST['observations_dimensions_mine'];
        $_SESSION['taches_forces_securite'] = $_POST['taches_forces_securite'];
        $_SESSION['incidents_securite'] = $_POST['incidents_securite'];
        $_SESSION['personnes_impliquees_incidents'] = $_POST['personnes_impliquees_incidents'];
        ...
        $_SESSION['evaluations_risques_securite'] = $_POST['evaluations_risques_securite'];
        $_SESSION['observations_evaluations_risques_securite'] = $_POST['observations_evaluations_risques_securite'];

        header("Location:form17.php");

        $req2 = $bdd->prepare('INSERT INTO minier_second(panneaux, observations_panneaux, portes_fermees,
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form15.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">SECURITE DU SITE</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">17 - SECURITE DU SITE</h3>
                                        </div>
                                        <hr>
                                        <form action="form16.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Au bureau de l’exploitant minier avec vérification sur site ; Réponses en OUI/NON avec notes/Actions/Observations de l'Inspecteur.
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>FORCES DE SECURITE</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Des forces de sécurité professionnelles contrôlent le site >>> forces publiques, spécifiez :
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="forces_publiques" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="forces_publiques" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="observations_forces_publiques" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_forces_publiques']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Des forces de sécurité professionnelles contrôlent le site forces privées, spécifiez :
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="forces_privees" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="forces_privees" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_forces_privees" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_forces_privees']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Sont-elles directement engagées par l’exploitant minier ?
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="forces_engagees_exploitant" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="forces_engagees_exploitant" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_forces_engagees_exploitant" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_forces_engagees_exploitant']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Nombre total des forces de sécurité sur le site
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="total_forces_securite" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="total_forces_securite" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_total_forces_securite" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_total_forces_securite']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                        Par rapport à la dimension de la mine (surface, nombre de mineurs, population locale),
                                                        pensez-vous que le nombre des forces de sécurité est suffisant pour contrôle du site ?
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="dimensions_mine" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="dimensions_mine" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_dimensions_mine" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_dimensions_mine']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>CONDUITE ET GESTION DES FORCES DE SECURITE</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Quelles sont les tâches spécifiques des forces de sécurité sur la mine ?
                                                        </label>

                                                        <div class="input-group">
                                                            <textarea name="taches_forces_securite" class="form-control" id="" cols="30" rows="10">
                                                                <?php echo $_SESSION['taches_forces_securite']?>
                                                            </textarea>
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                        Quel type d’incidents de sécurité s’est passé sur/autour de la mine depuis la dernière inspection ?
                                                        
                                                        </label>

                                                        <div class="input-group">
                                                            <textarea name="incidents_securite" class="form-control" id="" cols="30" rows="10">
                                                                <?php echo $_SESSION['incidents_securite']?>
                                                            </textarea>
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Qu’est-ce qui s’est passé avec les personnes impliquées ?
                                                        
                                                        </label>

                                                        <div class="input-group">
                                                            <textarea name="personnes_impliquees_incidents" class="form-control" id="" cols="30" rows="10">
                                                                <?php echo $_SESSION['personnes_impliquees_incidents']?>
                                                            </textarea>
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Existe-t-il une documentation sur ces incidents de sécurité ?
                                                        </label>
                                                        <div class="input-group">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="evaluations_risques_securite" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="evaluations_risques_securite" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_evaluations_risques_securite" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_evaluations_risques_securite']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="securite_site" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
