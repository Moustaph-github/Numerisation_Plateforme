<?php
    ...
    echo $_SESSION['site_minier'];

    if(isset($_POST['identification_entreprise'])) {


        $_SESSION['nom_exploitant'] = $_POST['nom_exploitant'];
        $_SESSION['phone_exploitant'] = $_POST['phone_exploitant'];
        $_SESSION['email_exploitant'] = $_POST['email_exploitant'];
        $_SESSION['siege_code_enreg'] = $_POST['siege_code_enreg'];
        $_SESSION['adresse_siege'] = $_POST['adresse_siege'];
        $_SESSION['type_societe'] = $_POST['type_societe'];
        $_SESSION['nom_represen_legal'] = $_POST['nom_represen_legal'];
        $_SESSION['phone_representant'] = $_POST['phone_representant'];
        $_SESSION['email_representant'] = $_POST['email_representant'];
        $_SESSION['responsable_site'] = $_POST['responsable_site'];
        $_SESSION['phone_resp_site'] = $_POST['phone_resp_site'];
        $_SESSION['email_resp_site'] = $_POST['email_resp_site'];
        $_SESSION['total_actionnaires'] = $_POST['total_actionnaires'];
        $_SESSION['actionnaires'] = $_POST['actionnaires'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Identification de l’entreprise <?php echo $_SESSION['site_minier'] ?> </div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">2 - Identification de l’entreprise <?php echo $_SESSION['site_minier'] ?></h3>
                                        </div>
                                        <hr>
                                        <form action="form1.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Nom de l’exploitant (société / coopérative)</label>
                                                        <input id="cc-exp" name="nom_exploitant" type="text" value="<?php echo $_SESSION['nom_exploitant']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="Nom exploitant"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Telephone Exploitant</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="phone_exploitant" type="text" value="<?php echo $_SESSION['phone_exploitant']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" placeholder="(+221) 77 350 70 50" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Email Exploitant</label>
                                                        <input id="cc-exp" name="email_exploitant" type="email" value="<?php echo $_SESSION['email_exploitant']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="xxx@mail.com"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Siège & code d’enregistrement national de l’exploitant minier</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="siege_code_enreg" type="text" value="<?php echo $_SESSION['siege_code_enreg']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" placeholder="siège & code enregistrement" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Adresse siège principal</label>
                                                        <input id="cc-exp" name="adresse_siege" type="text" value="<?php echo $_SESSION['adresse_siege']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="adresse siège"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Type de Société</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="type_societe" type="checkbox" class="form-control cc-cvc" value="Société mixte" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Société mixte
                                                        <input id="x_card_code" name="type_societe" type="checkbox" class="form-control cc-cvc" value="SA" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">SA
                                                        <input id="x_card_code" name="type_societe" type="checkbox" class="form-control cc-cvc" value="SARL" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">SARL
                                                        
                                                    </div>
                                                    <hr>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="type_societe" type="checkbox" class="form-control cc-cvc" value="GIE" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">GIE
                                                        <input id="x_card_code" name="type_societe" type="checkbox" class="form-control cc-cvc" value="Cooperative" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Cooperative
                                                        
                                                    </div>
                                                    <label for="cc-exp" class="control-label mb-1">Autres</label>
                                                    <input id="cc-exp" name="type_societe" type="text" value="<?php echo $_SESSION['type_societe']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="Autres"
                                                            autocomplete="cc-exp">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Nom du Representant legal de l'exploitant</label>
                                                        <input id="cc-exp" name="nom_represen_legal" type="text" value="<?php echo $_SESSION['nom_represen_legal']?>" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="Nom Representant de l'exploitant"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Telephone Representant</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="phone_representant" type="text" value="<?php echo $_SESSION['phone_representant']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" placeholder="(+221) 77 350 50 50" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Email Representant</label>
                                                        <input id="cc-exp" name="email_representant" type="email" value="<?php echo $_SESSION['email_representant']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="xxx@mail.com"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Nom de la personne responsable du site</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="responsable_site" type="text" value="<?php echo $_SESSION['responsable_site']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" placeholder="nom responsable site" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Telephone Responsable Site</label>
                                                        <input id="cc-exp" name="phone_resp_site" type="text" value="<?php echo $_SESSION['phone_resp_site']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="(+221) 77 350 50 40"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Email Responsable Site</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="email_resp_site" type="email" value="<?php echo $_SESSION['email_resp_site']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" placeholder="xxx@mail.com" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Nombre Total Actionnaire(s)</label>
                                                        <input id="cc-exp" name="total_actionnaires" type="number" value="<?php echo $_SESSION['total_actionnaires']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="Nombre actionnaires"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Listez les trois actionnaires principaux</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="actionnaires" type="text" value="<?php echo $_SESSION['actionnaires']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div>
                                                <button name="identification_entreprise" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
