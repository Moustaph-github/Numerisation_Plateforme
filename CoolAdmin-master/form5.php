<?php
    ...
    if(isset($_POST['investigations_geologiques'])) {


        $_SESSION['programme_exploration'] = $_POST['programme_exploration'];
        $_SESSION['observations_programme_exploration'] = $_POST['observations_programme_exploration'];
        $_SESSION['geologue_exploration'] = $_POST['geologue_exploration'];
        $_SESSION['observations_geologue_exploration'] = $_POST['observations_geologue_exploration'];
        $_SESSION['cartographie_geologique'] = $_POST['cartographie_geologique'];
        $_SESSION['observations_cartographie_geologique'] = $_POST['observations_cartographie_geologique'];
        $_SESSION['rapports_geologiques'] = $_POST['rapports_geologiques'];
        $_SESSION['observations_rapports_geologiques'] = $_POST['observations_rapports_geologiques'];
        $_SESSION['excavation'] = $_POST['excavation'];
        $_SESSION['observations_excavation'] = $_POST['observations_excavation'];
        $_SESSION['forage'] = $_POST['forage'];
        $_SESSION['observations_forage'] = $_POST['observations_forage'];
        $_SESSION['nombre_metres_fores'] = $_POST['nombre_metres_fores'];
        $_SESSION['observations_nombre_metres_fores'] = $_POST['observations_nombre_metres_fores'];

        $_SESSION['analyse_geochimique'] = $_POST['analyse_geochimique'];
        $_SESSION['observations_analyse_geochimique'] = $_POST['observations_analyse_geochimique'];
        $_SESSION['modelisation_estimation'] = $_POST['modelisation_estimation'];
        $_SESSION['observations_modelisation_estimation'] = $_POST['observations_modelisation_estimation'];
        $_SESSION['autres_activites_exploration'] = $_POST['autres_activites_exploration'];
        $_SESSION['observations_autres_activites_exploration'] = $_POST['observations_autres_activites_exploration'];
        $_SESSION['etude_faisabilite_reserves'] = $_POST['etude_faisabilite_reserves'];
        $_SESSION['observations_etude_faisabilite_reserves'] = $_POST['observations_etude_faisabilite_reserves'];
        $_SESSION['depenses_exploration'] = $_POST['depenses_exploration'];
        $_SESSION['observations_depenses_exploration'] = $_POST['observations_depenses_exploration'];
        $_SESSION['environnement_geologique'] = $_POST['environnement_geologique'];
        $_SESSION['epaisseur_orientation'] = $_POST['epaisseur_orientation'];
        $_SESSION['teneur'] = $_POST['teneur'];
        $_SESSION['reserves_ressources'] = $_POST['reserves_ressources'];
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="form5.php">Dashboard 1</a>
                                </li>
                                <!--<li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form4.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Investigations Géologiques</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">6 - Investigations Géologiques</h3>
                                        </div>
                                        <hr>
                                        <form action="form5.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Au bureau de l’exploitation minier et des autorités nationales (Rapport)
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Au bureau de l'exploitant minier</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Mise en place d’un programme d’exploration structuré</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="programme_exploration" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="programme_exploration" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="observations_programme_exploration" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_programme_exploration']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Un géologue d’exploration est présent sur le site</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="geologue_exploration" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="geologue_exploration" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_geologue_exploration" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_geologue_exploration']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Réalisation de la cartographie géologique (cartes disponibles et échelles)</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="cartographie_geologique" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="cartographie_geologique" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_cartographie_geologique" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_cartographie_geologique']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Elaboration des rapports géologiques</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="rapports_geologiques" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="rapports_geologiques" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_rapports_geologiques" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_rapports_geologiques']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Excavation (de puits ou de tranchées) pour l’échantillonnage géochimique</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="excavation" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="excavation" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_excavation" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_excavation']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Forage pour les analyses géochimiques échantillons et des carottes</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="forage" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="forage" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_forage" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_forage']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Nombre de mètres forés dans l'année (ou depuis la derniére inspection)</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="nombre_metres_fores" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="nombre_metres_fores" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_nombre_metres_fores" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_nombre_metres_fores']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Analyse géochimique régulière des échantillons</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="analyse_geochimique" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="analyse_geochimique" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_analyse_geochimique" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_analyse_geochimique']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Modélisation/estimation des ressources</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="modelisation_estimation" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="modelisation_estimation" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_modelisation_estimation" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_modelisation_estimation']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Autres activités d’exploration (précisez)</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="autres_activites_exploration" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="autres_activites_exploration" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_autres_activites_exploration" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_autres_activites_exploration']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Etude de faisabilité pour la définition des réserves</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="etude_faisabilite_reserves" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="etude_faisabilite_reserves" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_etude_faisabilite_reserves" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_etude_faisabilite_reserves']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Précisez les dépenses d’exploration de l’année passée</label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="depenses_exploration" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="depenses_exploration" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_depenses_exploration" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_depenses_exploration']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Environnement Géologique dominant</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="environnement_geologique" type="checkbox" class="form-control cc-cvc" value="Placer" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Placer
                                                            <input id="x_card_code" name="environnement_geologique" type="checkbox" class="form-control cc-cvc" value=" Roches mixtes" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Roches mixtes
                                                            <input id="x_card_code" name="environnement_geologique" type="checkbox" class="form-control cc-cvc" value="Roches cristallines massives" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Roches cristallines massives
                                                            <input id="x_card_code" name="environnement_geologique" type="checkbox" class="form-control cc-cvc" value="Terrils (Stériles ou anciens minerais)" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Terrils (Stériles ou anciens minerais)
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <label for="cc-exp" class="control-label mb-1">Roches sédimentaires :</label>
                                                            <input id="x_card_code" name="environnement_geologique" type="checkbox" class="form-control cc-cvc" value="Roches sedimetaires" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                            <input id="x_card_code" name="environnement_geologique" type="text" value="<?php echo $_SESSION['environnement_geologique']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" placeholder="Autres" autocomplete="off">    
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Epaisseur typique et orientation (filons)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="epaisseur_orientation" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['epaisseur_orientation']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Teneur typique (variété) de la minéralisation
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="teneur" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['teneur']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Réserves/ressources estimèes (inférèes, indiquées, mesurées)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="reserves_ressources" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['reserves_ressources']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="investigations_geologiques" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
