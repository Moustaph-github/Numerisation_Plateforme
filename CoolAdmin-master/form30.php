<?php
    ...
    if(isset($_POST['resumes_conclusions_recommandations'])) {


        $_SESSION['problemes_majeurs_site'] = $_POST['problemes_majeurs_site'];
        $_SESSION['actions_correctives'] = $_POST['actions_correctives'];
        $_SESSION['sante_securite_travailleurs_operations'] = $_POST['sante_securite_travailleurs_operations'];
        $_SESSION['decision_suspension_temporaire'] = $_POST['decision_suspension_temporaire'];
        $_SESSION['date_suspension'] = $_POST['date_suspension'];
        $_SESSION['cote_rouge_non_certifie'] = $_POST['cote_rouge_non_certifie'];
        $_SESSION['date_cote_rouge'] = $_POST['date_cote_rouge'];
        $_SESSION['periode_minimale_suspension'] = $_POST['periode_minimale_suspension'];
        $_SESSION['cote_jaune'] = $_POST['cote_jaune'];
        $_SESSION['date_cote_jaune'] = $_POST['date_cote_jaune'];
        $_SESSION['periode_grace'] = $_POST['periode_grace'];
        $_SESSION['cote_vert_certifie'] = $_POST['cote_vert_certifie'];
        $_SESSION['date_cote_vert_certifie'] = $_POST['date_cote_vert_certifie'];
        $_SESSION['date_inspection'] = $_POST['date_inspection'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form29.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">RESUME DES CONCLUSIONS ET DES RECOMMANDATIONS D’INSPECTION</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">31 - RESUME DES CONCLUSIONS ET DES RECOMMANDATIONS D’INSPECTION</h3>
                                        </div>
                                        <hr>
                                        <form action="form30.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        N’assignez l’état de certification du site qu’après avoir évalué toutes les exigences de cotation rouge/ jaune. Cette évaluation se fait au bureau, en tenant compte de tous les résultats d’inspection minière et en consultation avec le comité d’inspections / avec l’autorisation du Directeur de la DCSOM.
                                                        En cas de détection d’une cote rouge ou jaune (selon le système de certification), précisez cela directement à l’exploitant en lui signifiant les conséquences (arrêt direct d’activités d’exploitation, ou période de grâce de 6 mois pour effectuer des actions correctives). Respectez les définitions en ce qui concerne la classification de la cote rouge ou jaune vis-à-vis des exigences pour les sites « industriels » et « artisanaux » selon la classification de la CIRGL (section 32).
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    Problèmes majeures sur le site
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="problemes_majeurs_site" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['problemes_majeurs_site']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="actions_correctives" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['actions_correctives']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="sante_securite_travailleurs_operations" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['sante_securite_travailleurs_operations']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <label for="x_card_code" class="control-label mb-1">
                                                            Décision sur la suspension temporaire du site minier
                                                        </label>
                                                        <input id="x_card_code" name="decision_suspension_temporaire" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                        
                                                    </div>
                                                    <hr>
                                                    <label for="x_card_code" class="control-label mb-1">
                                                    En raison des problèmes mentionnés ci-dessus, le site minier est temporairement suspendu. La suspension sera levée après la mise en œuvre satisfaisante des mesures correctives, sous réserve de vérification par la DCSOM, à la date suivante :
                                                    </label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="date_suspension" type="date" class="form-control cc-cvc" value="<?php echo $_SESSION['date_suspension']?>" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Etat de certification du site minier (voir les pages suivantes)</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        Cote rouge (non-certifié) <input id="x_card_code" name="cote_rouge_non_certifie" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                                dès : <input id="x_card_code" name="date_cote_rouge" type="date" class="form-control cc-cvc" value="<?php echo $_SESSION['date_cote_rouge']?>" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                    </div>
                                                    <br>
                                                    <div class="input-group">
                                                    Période minimale de suspension : <input id="x_card_code" name="periode_minimale_suspension" type="date" class="form-control cc-cvc" value="<?php echo $_SESSION['periode_minimale_suspension']?>" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                    ...
                                                    <div class="input-group">
                                                        Côte jaune <input id="x_card_code" name="cote_jaune" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                        dès: <input id="x_card_code" name="date_cote_jaune" type="date" class="form-control cc-cvc" value="<?php echo $_SESSION['date_cote_jaune']?>" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                        
                                                    </div>
                                                    <br>
                                                    <div class="input-group">
                                                        Période de grâce prend fin le : <input id="x_card_code" name="periode_grace" type="date" class="form-control cc-cvc" value="<?php echo $_SESSION['periode_grace']?>" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                        
                                                    </div>
                                                    <hr>
                                                    <div class="input-group">
                                                        Côte vert (certifié) <input id="x_card_code" name="cote_vert_certifie" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                        dès: <input id="x_card_code" name="date_cote_vert_certifie" type="date" class="form-control cc-cvc" value="<?php echo $_SESSION['date_cote_vert_certifie']?>" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                                        
                                                    </div>
                                                    <br>
                                                    <div class="input-group">
                                                    Prochaine date d’inspection : <input id="x_card_code" name="date_inspection" type="date" class="form-control cc-cvc" value="<?php echo $_SESSION['date_inspection']?>" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">
                                            ...
                                            <div>
                                                <button name="resumes_conclusions_recommandations" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
