<?php
    ...
    if(isset($_POST['politique_exploitant'])) {


        $_SESSION['hsqe'] = $_POST['hsqe'];
        $_SESSION['environnement_bio_diversite'] = $_POST['environnement_bio_diversite'];
        $_SESSION['formation_personnel'] = $_POST['formation_personnel'];
        $_SESSION['rse'] = $_POST['rse'];
        $_SESSION['anti_corruption_fraude'] = $_POST['anti_corruption_fraude'];
        $_SESSION['genre'] = $_POST['genre'];
        $_SESSION['autre_politique_exploitant'] = $_POST['autre_politique_exploitant'];
        $_SESSION['cooperatives_entreprises'] = $_POST['cooperatives_entreprises'];
        $_SESSION['observations_cooperatives_entreprises'] = $_POST['observations_cooperatives_entreprises'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form14.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">POLITIQUE DE L'EXPLOITANT</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">16 - POLITIQUE DE L'EXPLOITANT</h3>
                                        </div>
                                        <hr>
                                        <form action="form15.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="hsqe" type="checkbox" class="form-control cc-cvc" value="Disponible" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Disponible
                                                            <input id="x_card_code" name="hsqe" type="checkbox" class="form-control cc-cvc" value="Communiqué à Tous les travailleurs" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Communiqué à Tous les travailleurs
                                                            <input id="x_card_code" name="hsqe" type="checkbox" class="form-control cc-cvc" value="renforcée" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">renforcée ?
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        <strong>
                                                            Environnement et Bio diversité
                                                        </strong>  
                                                    </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="environnement_bio_diversite" type="checkbox" class="form-control cc-cvc" value="Disponible" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Disponible
                                                            <input id="x_card_code" name="environnement_bio_diversite" type="checkbox" class="form-control cc-cvc" value="Communiqué à Tous les travailleurs" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Communiqué à Tous les travailleurs
                                                            <input id="x_card_code" name="environnement_bio_diversite" type="checkbox" class="form-control cc-cvc" value="renforcée" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">renforcée ?
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="formation_personnel" type="checkbox" class="form-control cc-cvc" value="Disponible" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Disponible
                                                            <input id="x_card_code" name="formation_personnel" type="checkbox" class="form-control cc-cvc" value="Communiqué à Tous les travailleurs" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Communiqué à Tous les travailleurs
                                                            <input id="x_card_code" name="formation_personnel" type="checkbox" class="form-control cc-cvc" value="renforcée" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">renforcée ?
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        <strong>
                                                            RSE : relations avec les communautés
                                                        </strong>  
                                                    </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="rse" type="checkbox" class="form-control cc-cvc" value="Disponible" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Disponible
                                                            <input id="x_card_code" name="rse" type="checkbox" class="form-control cc-cvc" value="Communiqué à Tous les travailleurs" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Communiqué à Tous les travailleurs
                                                            <input id="x_card_code" name="rse" type="checkbox" class="form-control cc-cvc" value="renforcée" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">renforcée ?
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="anti_corruption_fraude" type="checkbox" class="form-control cc-cvc" value="Disponible" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Disponible
                                                            <input id="x_card_code" name="anti_corruption_fraude" type="checkbox" class="form-control cc-cvc" value="Communiqué à Tous les travailleurs" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Communiqué à Tous les travailleurs
                                                            <input id="x_card_code" name="anti_corruption_fraude" type="checkbox" class="form-control cc-cvc" value="renforcée" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">renforcée ?
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="genre" type="checkbox" class="form-control cc-cvc" value="Disponible" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Disponible
                                                            <input id="x_card_code" name="genre" type="checkbox" class="form-control cc-cvc" value="Communiqué à Tous les travailleurs" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Communiqué à Tous les travailleurs
                                                            <input id="x_card_code" name="genre" type="checkbox" class="form-control cc-cvc" value="renforcée" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">renforcée ?
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="autre_politique_exploitant" type="checkbox" class="form-control cc-cvc" value="Disponible" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Disponible
                                                            <input id="x_card_code" name="autre_politique_exploitant" type="checkbox" class="form-control cc-cvc" value="Communiqué à Tous les travailleurs" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Communiqué à Tous les travailleurs
                                                            <input id="x_card_code" name="autre_politique_exploitant" type="checkbox" class="form-control cc-cvc" value="renforcée" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">renforcée ?
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        <strong>
                                                        Uniquement pour les coopératives/entreprises artisanales :
                                                        Existe-il des politiques établies verbalement (et non par écrit), qui sont communiquées àtous les travailleurs, et renforcées par la coopérative ?
                                                        </strong>  
                                                    </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="cooperatives_entreprises" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui (Précisez)
                                                            <input id="x_card_code" name="cooperatives_entreprises" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                            
                                                    </div>
                                                    <br>
                                                    <div class="input-group">
                                                        <textarea name="observations_cooperatives_entreprises" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_cooperatives_entreprises']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="politique_exploitant" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
