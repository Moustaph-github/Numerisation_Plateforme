<?php
    ...
    if(isset($_POST['travailleurs_miniers'])) {


        $_SESSION['travailleurs_site_minier'] = $_POST['travailleurs_site_minier'];
        $_SESSION['mineurs_masculins'] = $_POST['mineurs_masculins'];
        $_SESSION['mineurs_feminins'] = $_POST['mineurs_feminins'];
        $_SESSION['employes_permanents'] = $_POST['employes_permanents'];
        $_SESSION['employes_temporaires'] = $_POST['employes_temporaires'];
        $_SESSION['nbre_travailleurs'] = $_POST['nbre_travailleurs'];
        $_SESSION['fluctuation_saisonniere'] = $_POST['fluctuation_saisonniere'];
        $_SESSION['observations_fluctuation_saisonniere'] = $_POST['observations_fluctuation_saisonniere'];
        $_SESSION['organisation_travailleurs'] = $_POST['organisation_travailleurs'];
        $_SESSION['observations_organisation_travailleurs'] = $_POST['observations_organisation_travailleurs'];
        $_SESSION['evidence_exploitant'] = $_POST['evidence_exploitant'];
        $_SESSION['observations_evidence_exploitant'] = $_POST['observations_evidence_exploitant'];
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form19.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">TRAVAILLEURS MINIERS (EMPLOYES, SOUS-TRAITANTS, ET MINEURS ARTISANAUX)</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">21 - TRAVAILLEURS MINIERS (EMPLOYES, SOUS-TRAITANTS, ET MINEURS ARTISANAUX)</h3>
                                        </div>
                                        <hr>
                                        <form action="form20.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Sur site et au bureau de l’exploitant minier avec vérification sur site (mineurs)
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Nombre total de travailleurs</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="travailleurs_site_minier" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['travailleurs_site_minier']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="mineurs_masculins" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['mineurs_masculins']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="mineurs_feminins" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['mineurs_feminins']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="employes_permanents" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['employes_permanents']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">
                                                        Employés temporaires (f/m)
                                                    </label>
                                                    <div class="input-group">
                                                        <textarea name="employes_temporaires" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['employes_temporaires']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>Le nombre de travailleurs a été vérifié par</strong>
                                                        </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                            <input id="x_card_code" name="nbre_travailleurs" type="checkbox" class="form-control cc-cvc" value="L'enregistrement" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">L'enregistrement
                                                            <input id="x_card_code" name="nbre_travailleurs" type="checkbox" class="form-control cc-cvc" value="bulletins de paie" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Les dossiers de paiement (bulletins de paie)
                                                            
                                                            
                                                    </div>
                                                    <hr>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="nbre_travailleurs" type="checkbox" class="form-control cc-cvc" value="Les contrôles intermittents sur les sites miniers" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Les contrôles intermittents sur les sites miniers
                                                        <input id="x_card_code" name="nbre_travailleurs" type="checkbox" class="form-control cc-cvc" value="Les documents d’assurance" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Les documents d’assurance
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Y-a-t-il une fluctuation saisonnière des travailleurs sur le site minier ?
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="fluctuation_saisonniere" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="fluctuation_saisonniere" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea name="observations_fluctuation_saisonniere" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_fluctuation_saisonniere']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Existe-t-il une organisation des travailleurs ?
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="organisation_travailleurs" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="organisations_travailleurs" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_organisation_travailleurs" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_organisation_travailleurs']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            Y-a-t-il d’évidence que l’exploitant minier soutient l’organisation des travailleurs ? (précisez)
                                                        </label>
                                                        <div class="input-group">
                                                            <input id="x_card_code" name="evidence_exploitant" type="checkbox" class="form-control cc-cvc" value="Oui" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                            <input id="x_card_code" name="evidence_exploitant" type="checkbox" class="form-control cc-cvc" value="Non" data-val="true" data-val-required="Please enter the security code"
                                                                data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Non
                                                        </div>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="observations_evidence_exploitant" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['observations_evidence_exploitant']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="travailleurs_miniers" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
