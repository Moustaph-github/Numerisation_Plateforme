<?php
    ...
    if(isset($_POST['autres_commentaires'])) {


        $_SESSION['commentaire_un'] = $_POST['commentaire_un'];
        $_SESSION['commentaire_deux'] = $_POST['commentaire_deux'];
        $_SESSION['commentaire_trois'] = $_POST['commentaire_trois'];
        ...
        commentaire_un, commentaire_deux, commentaire_trois)
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');*/
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form24.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">AUTRES COMMENTAIRES</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">26 - AUTRES COMMENTAIRES</h3>
                                        </div>
                                        <hr>
                                        <form action="form25.php" method="post" novalidate="novalidate">
                                            
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="x_card_code" class="control-label mb-1">Observations</label>
                                                    <div class="input-group">
                                                        <textarea name="commentaire_un" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['commentaire_un']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        <textarea name="commentaire_deux" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['commentaire_deux']?>
                                                        </textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        <textarea name="commentaire_trois" class="form-control" id="" cols="30" rows="10">
                                                            <?php echo $_SESSION['commentaire_trois']?>
                                                        </textarea>
                                            ...
                                            <div>
                                                <button name="autres_commentaires" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
