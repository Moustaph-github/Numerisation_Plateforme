<?php
    ...
    if(isset($_POST['etat_administratif_titre'])) {

        $_SESSION['type_permis'] = $_POST['type_permis'];
        $_SESSION['num_degre_agrement'] = $_POST['num_degre_agrement'];
        $_SESSION['date_delivrance'] = $_POST['date_delivrance'];
        $_SESSION['date_expiration'] = $_POST['date_expiration'];
        $_SESSION['type_exploitation'] = $_POST['type_exploitation'];
        $_SESSION['assurance_sociale'] = $_POST['assurance_sociale'];
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="form3.php">Dashboard 1</a>
                                </li>
                                <!--<li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <a href="form2.php" class="btn btn-primary"> >>> Revenir étape précédente</a>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">Etat administratif du titre</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">4 - Etat administratif du titre</h3>
                                        </div>
                                        <hr>
                                        <form action="form3.php" method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Type de permis</label>
                                                        <select name="type_permis" id="select" class="form-control">
                                                            <option value="null">Choisir un type de permis</option>
                                                            <option value="AP">AP</option>
                                                            <option value="PR">PR</option>
                                                            <option value="PE">PE</option>
                                                            <option value="Carriere">Carriére</option>
                                                        </select>
                                                        <label for="cc-exp" class="control-label mb-1">
                                                            <strong>(AP: Autorisation de Prospection; PR: Permis de Recherche; PE: Permis d'Exploitation ; Carriére)</strong>
                                                        </label>
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">N° de décret ou N° d’Agrément Ministérielle</label>
                                                    <input id="cc-exp" name="num_degre_agrement" value="<?php echo $_SESSION['num_degre_agrement']?>" type="text" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="N°"
                                                            autocomplete="cc-exp">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Date de délivrance</label>
                                                        <input id="cc-exp" name="date_delivrance" type="date" value="<?php echo $_SESSION['date_delivrance']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Date d’expiration</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="date_expiration" type="date" value="<?php echo $_SESSION['date_expiration']?>" class="form-control cc-cvc" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="cc-exp" class="control-label mb-1">Type d’exploitation</label>
                                                        <input id="cc-exp" name="type_exploitation" type="text" value="<?php echo $_SESSION['type_exploitation']?>" class="form-control cc-exp" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="type d'exploitation"
                                                            autocomplete="cc-exp">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Participation de l’exploitant minier dans un système d’assurance sociale</label>
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="assurance_sociale" type="checkbox" class="form-control cc-cvc" value="oui" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off">Oui
                                                        <input id="x_card_code" name="assurance_sociale" type="checkbox" class="form-control cc-cvc" value="non" data-val="true" data-val-required="Please enter the security code"
                                            ...
                                            <div>
                                                <button name="etat_administratif_titre" id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
